...
public class JavaLessonThirtyNine extends JFrame implements HyperlinkListener, ActionListener{

	public static void main(String[] args){
		
		new JavaLessonThirtyNine("http://lovi.fm/station/1638/similar/");
	...
	public JavaLessonThirtyNine(String defaultURL){
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == theURL){
			...
			JOptionPane.showMessageDialog(JavaLessonThirtyNine.this, 
